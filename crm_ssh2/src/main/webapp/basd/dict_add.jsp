...
<div class="button_bar">
	...
	<button class="common_button" onclick="doAdd()">保存</button>
</div>
<table class="query_form_table">
	<tr>
		<th>编号</th>
		<td><span id="bdId">${bdId }</span></td>
		<th>类别</th>
		<td><input id="bdType" /><span class="red_star">*</span>
	</tr>
	<tr>
		<th>条目</th>
		<td><input id="bdItem"/><span class="red_star">*</span></td>
		<th>值</th>
		<td><input id="bdValue" /><span class="red_star">*</span></td>
	</tr>	
	<tr>
		<th>是否可编辑</th>
		<td>
...
function doAdd(){
	$.ajax({
		...
		url : contextPath+"/basd/basdDictAction_add.action",
		dataType : 'json',
