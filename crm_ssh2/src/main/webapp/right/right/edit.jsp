...
<script src="<%=path%>/script/validate.js"></script>
	...
	<body>
		...
		<form action="/sysRight" method="post">
			<input type="hidden" name="o" value="editSysRight"/>
			...
			<table class="query_form_table">
				<tr>
					...
					<td>
						<input type="text" name="sysRight.rightCode" value="111"/>
					</td>
					<th>
						权限类型
					</th>
				...
				<tr>
					...
					<td>
						<input type="text" name="sysRight.rightText" value="222"/>
					</td>
					<th>
						权限URL
					</th>
					<td>
						<input type="text" name="sysRight.rightUrl" value="2323"/>
					</td>
					<th>权限描述</th>
					<td>
						<input type="text" name="sysRight.rightTip" value="231"/>
					</td>
				</tr>
			</table>
			<script>
