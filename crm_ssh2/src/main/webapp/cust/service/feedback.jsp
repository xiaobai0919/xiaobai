...
<body class="easyui-layout">
	...
	<div id="tb">
		<a id="clBtn" href="#" class="" data-bind="LinkButton:enableButton,click:doMYD" data-options="iconCls:'icon-edit',plain:true">处理</a>
	</div>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath }/ViewModel/cust/service/feedback.js"></script>
	<script type="text/javascript">
		var vm = new ViewModelFeedback();
		ko.applyBindings(vm);	
	</script>
</body>
</html>