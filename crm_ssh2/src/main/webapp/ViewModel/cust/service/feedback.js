function ViewModelFeedback(data){
	var _this = this;
	...
	//datagrid绑定数据
	this.listOptions = {
		url : contextPath+"/cust/custServiceAction_list.action?str=已处理",
	...
	this.doMYD = function(){
		if(_this.selectRowIndex!=-1){
			location.href = contextPath+"/cust/custServiceAction_toMYD.action?csId="+_this.selectRow.csId;
		}
	};
